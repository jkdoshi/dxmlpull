 ...
 *       returns char[] ("1.0") or null if XMLDecl was not read or if property is not supported
 * <li><b>standalone</b>:
...
interface XmlPullParser {
     ...
     * @see #setFeature
     */
    const char[] FEATURE_PROCESS_NAMESPACES =
     ...
     * @see #setFeature
     */
    const char[] FEATURE_REPORT_NAMESPACE_ATTRIBUTES =
     ...
     * @see #setFeature
     */
    const char[] FEATURE_PROCESS_DOCDECL =
     ...
     */
    void setProperty(char[] name,
                            char[] value) /* throws XmlPullParserException */;
     ...
     */
    void setInput(InputStream input) /* throws XmlPullParserException */;
     ...
     */
    //void setInput(InputStream inputStream, char[] inputEncoding)
     ...
     * @see #FEATURE_VALIDATION
     */
    void defineEntityReplacementText( char[] entityName,
                                            char[] replacementText ) /* throws XmlPullParserException */;
     ...
     *          char[] prefix = pp.getNamespacePrefix(i);
     *          char[] ns = pp.getNamespaceUri(i);
     *           // ...
     *      }
     * </pre>
     *
     ...
     */
    char[] getNamespacePrefix(int pos) /* throws XmlPullParserException */;
     ...
     */
    char[] getNamespaceUri(int pos) /* throws XmlPullParserException */;
    ...
    /**
     * Returns the text content of the current event as char[].
     ...
     * as empty string.
     * If namespaces are not enabled, an empty char[] ("") is always returned.
     ...
     */
    char[] getAttributeValue(char[] namespace,
                                    char[] name);
     ...
     * </pre>
     */
    void require(int type, char[] namespace, char[] name)
        /* throws XmlPullParserException, IOException */;
     ...
     * </pre>
     */
    char[] nextText() /* throws XmlPullParserException, IOException */;
...
class XmlPullParserException : TracedException {
	this(char[] msg) {
		super(msg);
	}
	this(char[] msg, XmlPullParser parser) {
		super((msg is null ? "" : msg ~ " ")
	               ~ (parser is null ? "" : "(position:" ~ parser.getPositionDescription() ~ ") "));
        if (parser != null) {
...
class IndexOutOfBoundsException : TracedException {
	this(char[] msg) {
		super(msg);
	}
}
